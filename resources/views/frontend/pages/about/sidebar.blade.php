 <aside class="sidebar">
     <div id="custom_html-4" class="widget_text widget gt3_widget open widget_custom_html">
         <div class="textwidget custom-html-widget"><img class="alignnone size-full wp-image-1456"
                 src="/frontend/assets/img/logo_retinablack.png" alt="" width="149" height="48" />
         </div>
     </div>
         ...
         <div class="textwidget custom-html-widget">
             <div class="textwidget">
                 ...
                 <p><a class="gt3_icon_link gt3_custom_color"
                         ...
                         data-hover-color="#f47215"><img class="alignnone" src="/frontend/assets/img/map_point.png"
                             alt="" width="12" height="17"
                             style="margin-right: 10px; margin-left: 3px"></a>27
                     Division St, New York, NY 10002, United States</p>
             </div>
         </div>
     </div>
