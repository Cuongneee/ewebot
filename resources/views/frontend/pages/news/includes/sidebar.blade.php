<aside class="sidebar">
    <div id="custom_html-4" class="widget_text widget gt3_widget open widget_custom_html">
        <div class="textwidget custom-html-widget"><img class="alignnone size-full wp-image-1456"
                src="/frontend/assets/img/logo_retinablack.png" alt="" width="149"
                height="48" /></div>
    </div>
        ...
        <div class="textwidget custom-html-widget">
            <div class="textwidget">
                ...
                <p><a class="gt3_icon_link gt3_custom_color"
                        ...
                        href="#" target="_blank" rel="noopener noreferrer" data-color="#5747e4"
                        data-hover-color="#f47215"><img class="alignnone"
                            src="https://ewebotwp.com/wp-content/uploads/2019/09/map_point.png" alt=""
                            width="12" height="17" style="margin-right: 10px; margin-left: 3px"></a>27 Division
                    St, New York, NY
        ...
        <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-9431" method="post" data-id="9431"
            ...
            <div class="mc4wp-form-fields">
                ...
                <div class="mc_signup_submit">
                    ...
                    name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input
                type="hidden" name="_mc4wp_timestamp" value="1750128745" /><input type="hidden" name="_mc4wp_form_id"
                value="9431" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" />
    ...
    <div id="block-8" class="widget gt3_widget open widget_block">
        <div class="textwidget">
            <p><a class="gt3_icon_link gt3_custom_color"
                    ...
                    style="font-size: 16px;color: #9794b4;margin-right: 15px;margin-top: 5px" href="#"
                    target="_blank" rel="noopener noreferrer" data-color="#9794b4" data-hover-color="#3b5998"><i
                        class="fa fa-facebook">&nbsp;</i></a><a class="gt3_icon_link gt3_custom_color"
                    style="font-size: 16px;color: #9794b4;margin-right: 15px;margin-top: 5px" href="#"
                    target="_blank" rel="noopener noreferrer" data-color="#9794b4" data-hover-color="#f04b3f"><i
                        class="fa fa-pinterest-p">&nbsp;</i></a> <a class="gt3_icon_link gt3_custom_color"
                    style="font-size: 16px;color: #9794b4;margin-right: 15px;margin-top: 5px" href="#"
                    target="_blank" rel="noopener noreferrer" data-color="#9794b4" data-hover-color="#007bb6"><i
