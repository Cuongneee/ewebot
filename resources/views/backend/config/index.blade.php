                        ...
                        <div class="row">
                            ...
                            <div id="addresses-wrapper" class="mb-3 col-lg-12">
                                ...
                                @foreach ($addresses as $address)
                                    <div class="address-group d-flex gap-2 mb-2">
                                        <input type="text" name="address[]" class="form-control"
                                            placeholder="Nhập địa chỉ" value="{{ $address }}">
                                        <button type="button" class="btn btn-danger"
                                            onclick="removeAddressInput(this)">-</button>
                                    </div>
                                @endforeach

                                <button type="button" class="btn btn-primary btn-sm mt-2" onclick="addAddressInput()">+
                                    Thêm địa chỉ</button>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function addAddressInput() {
            ...
            group.className = 'address-group d-flex gap-2 mb-2';
            ...
            removeBtn.onclick = function() {
                removeAddressInput(removeBtn);
            };

            group.appendChild(input);
            group.appendChild(removeBtn);

            wrapper.insertBefore(group, wrapper.querySelector('button.btn-primary'));
        }
