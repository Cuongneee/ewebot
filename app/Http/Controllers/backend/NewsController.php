...
class NewsController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('backend.news.form', compact('title', 'page', 'new', 'isEdit', 'categories', 'seoData'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.news.form', compact('new', 'title', 'page', 'isEdit', 'categories', 'seoData'));
    }
    ...
    public function getSeoAnalysis(Request $request, $id = null)
    {
        ...
        $analysisResult = $analyzer->analyze($new->seo_title = '', $new->content, $focusKeyword, $new->seo_description ?? '', $new->slug);
